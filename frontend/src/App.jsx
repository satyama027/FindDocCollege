...
function App() {
  ...
  const connectWebSocket = () => {
    ...
    ws.current = new WebSocket('ws://localhost:8000/ws/extract');
        ...
        <div className="card">
          ...
          {!searchResult.failed && (
            <>
              ...
              <div className="result-item">
                <div className="result-label">Practo URL</div>
                <div className="result-value">
                  <a href={searchResult.practo_url} target="_blank" rel="noreferrer">
                    {searchResult.practo_url}
                  </a>
                </div>
              </div>
            </>
